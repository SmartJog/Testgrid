CREATE TABLE Nodes(id INTEGER PRIMARY KEY AUTOINCREMENT, typename VARCHAR(25), name VARCHAR(25), is_transient INT default 0, is_quarantined INT default 0, error VARCHAR(25));
